...
BOT_TOKEN = "8597616914:AAGm47Wh7B70NTG3AKLJZHn4xWdk-QNPCho"
...
def contact_handler(message):
    bot.send_message(message.chat.id, "📞 Contact: @tufan_sir_here")
...
if __name__ == "__main__":
    logger.info("Starting 24x7 TUFAN HOSTING BOT...")
    start_bot()